...
public abstract class BaseLegacyKeyringTest {
    ...
    public void setUp() throws Exception {
        ...
        legacyKeyring = new LegacyKeyringImpl(
                sessionsService, users, permissions, keyringCache, schedulerKeyCache, applicationKeys);
    ...
    protected void verifyKeyAddedToSchedulerCache() throws Exception {
        verify(schedulerKeyCache, times(1)).add(TEST_COLLECTION_ID, secretKey);
        verifyNoMoreInteractions(schedulerKeyCache);
    }
