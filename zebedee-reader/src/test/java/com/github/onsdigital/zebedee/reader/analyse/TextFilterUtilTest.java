...
/**
 * Created by fawks on 25/01/2017.
 */
public class TextFilterUtilTest {
    ...
    public void testExtractAlphaNumericOrderedTokens() throws Exception {
        assertEquals(Lists.newArrayList("artichoke arugula asparagus artichoke avocado bamboo_shoots basil artichoke beans beets".split(" ")),
    ...
    public void extractAlphaNumericCaseSensitiveUniqueTokens() throws Exception {
        assertEquals(Sets.newHashSet("artichoke arugula asparagus artichoke avocado bamboo_shoots basil artichoke beans beets".split(" ")),
